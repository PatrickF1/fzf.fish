...
- **Remarks**
  - prepends `./` to the selection if only one selection is made, making it easier to execute it if it's a program, or cd into it if it's a directory (see [cd docs][])
