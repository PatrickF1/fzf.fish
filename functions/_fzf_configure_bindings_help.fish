function _fzf_configure_bindings_help
    ...
    echo 'Usage:'
    echo '    fzf_configure_bindings                                       Use the default key bindings'
    echo '    fzf_configure_bindings --searchable_entity=key_sequence...   Use but override one or more default key bindings'
    echo '    fzf_configure_bindings --searchable_entity                   Use but don\'t bind one more more default key bindings'
    echo 'Description:'
